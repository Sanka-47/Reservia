...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Customer full name (Auto-populated if logged in)',
        example: 'Alice Smith',
        required: false,
    }),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Customer email address (Auto-populated if logged in)',
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Customer phone number (Auto-populated if logged in)',
        example: '+1234567890',
        required: false,
    }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        example: 'Prefer a window seat if possible.',
        required: false,
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
