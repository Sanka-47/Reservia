...
async function main() {
  ...
  try {
    ...
    // 1. Clean slate deletion to ensure deterministic state
    ...
    const servicesMap: { [title: string]: string } = {};
    ...
    const bookingsData = [
      // John Doe Bookings (11 bookings to show pagination: limit is 5, so 3 pages)
      {
      ...
      // Jane Smith Bookings (7 bookings)
      {
